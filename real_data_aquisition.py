"""
Aquire and save continously data from PCB-board.
...
def get_data_from_USB_PCB (filename, limit_time, scale="high", port="COM3", baudrate=115200, timeout=2, rx_size=1000000, tx_size=1000000):
    """
    ...
    factor = 10e5 if scale == "high" else 10e3 #used for resitance calcualtion
    ...
    with open(filename, 'w', newline='') as f:
        ...
        while elapsed_time < limit_time:
            ...
            resistance_data = np.insert(resistance, 0, [got_data - start_time, got_data - start_time + 0.015],
